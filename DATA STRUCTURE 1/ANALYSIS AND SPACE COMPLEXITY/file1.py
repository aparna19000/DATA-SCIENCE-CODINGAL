...
# PART 1: Setup — 10 sorted quiz scores, target = 98, 
...
# Scans every score from the start. 
# Target at the end = worst case = n steps.
...
# lo and hi mark the search window. 
# mid is the midpoint. Each step halves the window.
